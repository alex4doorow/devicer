...
@Entity
@Table(name = "D_ADDRESS_TYPE")
@Setter
@Getter
@NoArgsConstructor
public class SEAddressType implements BaseEntity<Long>, Serializable {

    @Serial
    private static final long serialVersionUID = -2583971456782156656L;
