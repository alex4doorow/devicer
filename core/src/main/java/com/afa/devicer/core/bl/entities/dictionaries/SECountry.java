...
@Entity
@Table(name = "D_COUNTRY_TYPE")
@Setter
@Getter
@NoArgsConstructor
public class SECountry implements BaseEntity<Long>, Serializable {

    @Serial
    private static final long serialVersionUID = 4319476892030149365L;
