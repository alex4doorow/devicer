...
@Entity
@Table(name = "D_ORDER_PAYMENT")
@Setter
@Getter
@NoArgsConstructor
public class SEOrderPaymentType implements BaseEntity<Long>, Serializable {

    @Serial
    private static final long serialVersionUID = -7547370468622890501L;
